				    ...
				    <div class='card-body'>
				        ...
				        <div class='table-responsive'>
				            <table class='table table-striped ' >
				                ...
				                <tbody>
				                	<% List<Biglietto> listaBiglietti = (List<Biglietto>)request.getAttribute("listaDiBiglietti");
				                    ...
				                    <tr >
				                        ...
				                        <td>
											<a class="btn  btn-sm btn-outline-secondary" href="ExecuteVisualizzaBigliettoServlet?idArticolo=<%=item.getId() %>">Visualizza</a>
