			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="${pageContext.request.contextPath }/ExecuteInsertBigliettoServlet" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-3">
									...
									<input class="form-control"  name="data" id="data" type="date" placeholder="dd/MM/yy" title="formato : gg/mm/aaaa" 
										value="${biglietto_attr.data==null? '': biglietto_attr.data}" required/>
								</div>
